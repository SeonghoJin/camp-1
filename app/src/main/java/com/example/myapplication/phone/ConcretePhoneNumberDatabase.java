...
public class ConcretePhoneNumberDatabase {
    ...
    public static PhoneNumberDao getDatabase(@NonNull Context context){
        if(database == null){
            ...
            database.insertAll(phoneNumbers);
        }
